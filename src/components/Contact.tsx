      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h3 className="text-2xl font-bold mb-6">让我们一起工作</h3>
              <p className="text-gray-300 mb-8 leading-relaxed">
                如果您对我的工作感兴趣，或者有项目需要合作，欢迎随时联系我。
                我期待与您共同创造出色的数字产品。
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 7.89a2 2 0 002.82 0L21 8M12 3v18" />
                    </svg>
                  </div>
                  <div>
                    <div className="font-semibold">邮箱</div>
                    <div className="text-gray-400">ergou@example.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">北京市海淀区</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">周一至周五 9:00 - 18:00</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">查看我的开源项目</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">职业社交平台</div>
                  </div>
                </a>

                <a 
                  href="mailto:ergou@example.com"
                  className="flex items-center gap-4 p-4 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors"
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">直接联系我</div>
                  </div>
                </a>
              </div>
            </div>
